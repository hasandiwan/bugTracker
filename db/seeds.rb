...
#Users
harold = User.create(first_name: "Harold", last_name: "Torres", role: admin, email: "harold@example.com", password: "password")
siri = User.create(first_name: "Siri", last_name: "Watasir", role: project_manager, email: "siri@example.com", password: "password")
grandma = User.create(first_name: "Grandma", last_name: "Boss", role: project_manager, email: "nana@example.com", password: "password")
tan = User.create(first_name: "Tan", last_name: "Watasir", role: lead_developer, email: "tan@example.com", password: "password")
hernando = User.create(first_name: "Hernando", last_name: "Torres", role: lead_developer, email: "hernando@example.com", password: "password")
...
sindy = User.create(first_name: "Sindy", last_name: "Galvan", role: developer, email: "sd@example.com", password: "password")
wendy = User.create(first_name: "Wendy", last_name: "Galvan", role: developer, email: "wd@example.com", password: "password")
angie = User.create(first_name: "Angie", last_name: "Torres", role: developer, email: "angie@example.com", password: "password")
miguel = User.create(first_name: "Miguel", last_name: "Alzate", role: developer, email: "migue@example.com", password: "password")
carlos = User.create(first_name: "Carlos", last_name: "Martinez", role: developer, email: "carlos@example.com", password: "password")
melissa = User.create(first_name: "Melissa", last_name: "De la Cruz", role: developer, email: "mel@example.com", password: "password")
